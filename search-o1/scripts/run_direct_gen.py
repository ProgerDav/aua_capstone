...
from prompts import (get_task_instruction_code, get_task_instruction_math,
...
def main():
    ...
    if repetition_penalty is None:
        repetition_penalty = (
            ...
            or "deepseek" in model_path.lower()
            or "sky-t1" in model_path.lower()
            else 1.0
        )
    ...
    if model_short_name in [
        ...
        output_dir = (
            f"./outputs/runs.baselines/{dataset_name}.{model_short_name}.direct"
        )
