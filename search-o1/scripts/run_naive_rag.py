...
from prompts import (get_naive_rag_instruction, get_task_instruction_code,
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Run Naive RAG for various datasets and models."
    )
...
def main():
    ...
    if "qwq" in model_path.lower():
        ...
        output_dir = (
            f"./outputs/runs.baselines/{dataset_name}.{model_short_name}.naive_rag"
        )
