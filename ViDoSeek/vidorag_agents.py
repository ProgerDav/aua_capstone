        ...
        while True:
            ...
            try:
                ...
                if (
                    ...
                    or summary is None
                    or any(
                        [page >= len(self.buffer_images) for page in select_page_num]
                    )
                ):
                    raise Exception(
...
"""
1. Seeker: Image choice - Select the images that are useful to answer the question
    - The input is the question and the images
    - The output is the selected images and the summary of the selected images
2. Inspector: Image choice with Information
    - Select the images that are useful to answer the question
    - The input is the question and the selected images
    - The output is the selected images and the information of the selected images
        - We have also a reasoning part inside the inspector, it is used to discuss the answer, why we have this answer
3. Synthesizer: Receive the question, the useful information and the selected images, and generate the final answer
