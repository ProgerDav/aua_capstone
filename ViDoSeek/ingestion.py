    ...
    def ingestion_example(self, input_file, output_file):
        ...
        if input_file.endswith(".jpg") or input_file.endswith(".png"):
            documents = self.reader.load_file(
                Path(input_file), self.reader.file_metadata, self.reader.file_extractor
            )
    ...
    def ingestion_multi_session(self):
        ...
        if self.workers == 1:
            ...
            with ThreadPoolExecutor(max_workers=self.workers) as executor:
                future_to_file = {
                    executor.submit(self.ingestion_example, input_file, output_file): (
                        input_file,
                        output_file,
                    )
...
if __name__ == "__main__":
    root_path = "./data"
    datasets = ["ViDoSeek", "ExampleDataset", "SlideVQA"]
    for dataset in datasets:
        ...
        ingestion = Ingestion(
            ...
            embed_model_name="nomic-ai/colnomic-embed-multimodal-7b",
        )  # colqwen2
        # run
