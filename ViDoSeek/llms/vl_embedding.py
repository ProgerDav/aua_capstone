...
class VL_Embedding(MultiModalEmbedding):
    ...
    mode: str = Field(
        default="text", description="The mode of the model, either 'text' or 'image'."
    )
    ...
    embed_model: Union[ColQwen2_5, AutoModel, None] = Field(default=None)
    processor: Optional[ColQwen2_5_Processor] = Field(default=None)
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if "openbmb" in model:
            ...
            self.processor = ColQwen2_5_Processor.from_pretrained(model)
    ...
    def __call__(self, nodes, **kwargs):
        if "vidore" in self.model or "colnomic" in self.model:
            if self.mode == "image":
...
if __name__ == "__main__":
    colpali = VL_Embedding("nomic-ai/colnomic-embed-multimodal-7b")
    image_embeddings = colpali.embed_img(
        "/home/emanuele/11_neohorizon_benchmark/ViDoRAG/data/ViDoSeek/img/00a76e3a9a36255616e2dc14a6eb5dde598b321f_1.jpg"
    )
