...
def eval_search(examples):
    ...
    if examples[0].get("recall_results", None) is not None:
        for example in tqdm(examples):
            ...
            # 0 ='00a76e3a9a36255616e2dc14a6eb5dde598b321f_11.jpg'
            # 1 ='00a76e3a9a36255616e2dc14a6eb5dde598b321f_3.jpg'
            # 2 ='00a76e3a9a36255616e2dc14a6eb5dde598b321f_19.jpg'
            # 3 ='00a76e3a9a36255616e2dc14a6eb5dde598b321f_7.jpg'
            # 4 ='00a76e3a9a36255616e2dc14a6eb5dde598b321f_12.jpg'
            # 5 ='00a76e3a9a36255616e2dc14a6eb5dde598b321f_23.jpg'
            retrieved_docs_list.append([doc.split(".")[0] for doc in retrieved_docs])
            # 0 ='00a76e3a9a36255616e2dc14a6eb5dde598b321f_11'
            # 1 ='00a76e3a9a36255616e2dc14a6eb5dde598b321f_3'
            # 2 ='00a76e3a9a36255616e2dc14a6eb5dde598b321f_19'
            # 3 ='00a76e3a9a36255616e2dc14a6eb5dde598b321f_7'
            # 4 ='00a76e3a9a36255616e2dc14a6eb5dde598b321f_12'
            # 5 ='00a76e3a9a36255616e2dc14a6eb5dde598b321f_23'
        for k in [-1, 1, 5, 10]:
...
"""
'uid' =
'00a76e3a9a36255616e2dc14a6eb5dde598b321f_1'
'query' =
'Which areas are located on the English Channel coast?'
'reference_answer' =
'Kent, East Sussex, Normandy, Brittany'
'meta_info' =
{'file_name': '00a76e3a9a36255616e2dc14a6eb5dde598b321f.pdf', 'reference_page': [11], 'source_type': '2d_layout', 'query_type': 'content_extraction'}
'eval_result' =
{'score': 2, 'passing': 0, 'judge': '2.0\nThe generated answer lists some areas correctly (Kent, East Sussex, Normandy) but...el coast. Therefore, it contains mistakes.'}
'response' =
['Cornwall', 'Devon', 'Kent', 'East Sussex', 'Normandy']
'recall_results' =
{'source_nodes': [{...}, {...}, {...}, {...}, {...}, {...}], 'response': None, 'metadata': None}


source_nodes:
'node' = 
    {
        'id_': 'e3b1396b-b290-45db-bf7f-3d7faad0a287', 'embedding': None, 
        'metadata': {'file_name': './data/ExampleDataset/img/00a76e3a9a36255616e2dc14a6eb5dde598b321f_11.jpg'}, 
        'excluded_embed_metadata_keys': [], 'excluded_llm_metadata_keys': [], 'relationships': {}, 
        'metadata_template': '{key}: {value}', 'metadata_separator': '\n', 'text': '', 
        'mimetype': 'text/plain', 'start_char_idx': None, 'end_char_idx': None, 
        'metadata_seperator': '\n', 'text_template': '{metadata_str}\n\n{content}', 
        'image': None, 'image_path': './data/ExampleDataset/img/00a76e3a9a36255616e2dc14a6eb5dde598b321f_11.jpg', 
        'image_url': None, 'image_mimetype': 'image/jpeg', 'text_embedding': None, 'class_name': 'ImageNode'
    }
'score' = None
